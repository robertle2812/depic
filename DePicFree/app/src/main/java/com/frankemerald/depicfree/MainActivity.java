package com.frankemerald.depicfree;
...
import com.frankemerald.depicfree.FramesHelper.FrameEightHelper;
import com.frankemerald.depicfree.FramesHelper.FrameFirstHelper;
import com.frankemerald.depicfree.FramesHelper.FrameNineHelper;
import com.frankemerald.depicfree.Listeners.ContainersHider;
import com.frankemerald.depicfree.Listeners.ImageClickListener;
import com.frankemerald.depicfree.FramesHelper.FrameFiveHelper;
import com.frankemerald.depicfree.FramesHelper.FrameFourHelper;
import com.frankemerald.depicfree.FramesHelper.FrameSevenHelper;
import com.frankemerald.depicfree.FramesHelper.FrameSixHelper;
import com.frankemerald.depicfree.FramesHelper.FrameThreeHelper;
import com.frankemerald.depicfree.FramesHelper.FrameTwoHelper;
import com.frankemerald.depicfree.Models.Text;
import com.frankemerald.depicfree.Sharing.FacebookSharing;
import com.frankemerald.depicfree.UIHelpers.FilterBarHelper;
import com.frankemerald.depicfree.UIHelpers.MenuHelper;
import com.frankemerald.depicfree.UIHelpers.TextBarHelper;
import com.frankemerald.depicfree.UIHelpers.UIHelper;
import com.frankemerald.depicfree.Utils.FontManager;
...
public class MainActivity extends AppCompatActivity implements View.OnTouchListener {
    ...
    private void prepareTopRightButton() {
        ...
        gopro = (ImageView) findViewById(R.id.goPro);
        gopro.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openProVersionInMarket();
            }
        });
    }
    ...
    public void setFramework(int numberOfFrame){
        ...
        for(int i=0; i<frameworkScrolllayout.getChildCount();i++){
            if(i==numberOfFrame){
                ((ImageView)((RelativeLayout)frameworkScrolllayout.getChildAt(i)).getChildAt(0)).setImageResource(UIHelper.drawableFrameActiveIds[i]);

            }
            else{
                ((ImageView)((RelativeLayout)frameworkScrolllayout.getChildAt(i)).getChildAt(0)).setImageResource(UIHelper.drawableFrameInactiveIds[i]);
            }
        }
    ...
    private void openProVersionInMarket(){
        ...
        try {
            ...
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://play.google.com/store/apps/details?id=com.skaya.viewearthlivehd")));
        }
    }
    ...
    public void showProposeDialog(final int i){
        ...
        if(i==7)
            ad.setMessage("Please purchase Pro version, to have access to all functions of the application!");
            ...
            if(integer<100) {
                ...
                for(int k = 0;k<allPaths.length;k++){
                    ...
                    if (image == UIHelper.MAIN_CONTAINER) {
                        ...
                        ImageView plus = (ImageView) findViewById(R.id.plus_button_main);
                        plus.setVisibility(View.INVISIBLE);
                        FilterBarHelper.setThumbnails(MainActivity.this, image, false);
                        FilterBarHelper.updateThumbnail(MainActivity.this, image, false);
                        addButon.callOnClick();
                ...
                if(allPaths.length==1&&completedContainers[0]==UIHelper.MAIN_CONTAINER){
                    addButon.callOnClick();
                    FilterBarHelper.setThumbnails(MainActivity.this, 0, false);
                    FilterBarHelper.updateThumbnail(MainActivity.this, 0, false);
                }
//                if(currentContainerSelected>0)
//                    deactivateCurrentContainer(currentContainerSelected);
            }
